...
function getErrorMessage(code: ErrorCode, fallback: string): string {
  const keyMap: Record<ErrorCode, string> = {
    ...
    [ErrorCode.DOWNLOAD_PAUSED]: "errors.downloadPaused",
    ...
    [ErrorCode.CONFIG_LOAD_FAILED]: "errors.configLoadFailed",
    [ErrorCode.CONFIG_SAVE_FAILED]: "errors.configSaveFailed",
    [ErrorCode.PLUGIN_LOAD_FAILED]: "errors.pluginLoadFailed",
    [ErrorCode.PLUGIN_EXEC_FAILED]: "errors.pluginExecFailed",
    [ErrorCode.RSS_PARSE_FAILED]: "errors.rssParseFailed",
    [ErrorCode.RSS_FETCH_FAILED]: "errors.networkError",
    [ErrorCode.EXTRACT_FAILED]: "errors.extractFailed",
    [ErrorCode.PASSWORD_REQUIRED]: "errors.passwordRequired",
    [ErrorCode.INVALID_ARCHIVE]: "errors.invalidArchive",
